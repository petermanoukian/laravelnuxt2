...
const addcat = async () => {
  ...
  try 
  {
    const response = await $api.post(`${apiUrl}/admin/cat/add`, formData)
    console.log('Category added successfully:', response.data)
	addsuc.value = 'categoty added ' + name.value +  ' ... you will be redircted in a monent ...'
	...
	<div  class="bg-gray-100 font-family-karla flex">
		...
		<div class="relative w-full flex flex-col h-screen overflow-y-hidden">
			...
			<header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
				<div class="w-1/2"></div>
				<div  class="relative w-1/2 flex justify-end"> Add Category</div>
			</header>
